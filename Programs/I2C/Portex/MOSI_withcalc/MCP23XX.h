...
//uncomment line below to work with BANK=1 

//#undef Mode_16bit


/*
Configure chip to work in 16 bit or 8 bit mode
At power-on-reset the chip starts in 16 bit sequential mode
*/


#ifdef Mode_16bit                  //if Mode_16bit is defined, use folllowing macros
